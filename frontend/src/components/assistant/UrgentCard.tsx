    ...
    >
      <div className="flex items-center gap-2 border-b border-danger/20 bg-danger/[0.06] px-5 py-3">
        ...
        <h2 id="urgent-title" className="text-h4 font-semibold text-danger">
          {plan.title || "Time-sensitive — act soon"}
        </h2>
      </div>
      <div className="space-y-4 p-5">
        ...
        {steps.length > 0 && (
          <div>
            <p className="text-tiny font-semibold uppercase tracking-wide text-danger">Do this now</p>
        ...
        {plan.preserve_evidence && plan.preserve_evidence.length > 0 && (
          <div>
            <p className="text-tiny font-semibold uppercase tracking-wide text-muted">Preserve as evidence</p>
        ...
        {plan.reporting_path && (
          <div className="rounded-lg border border-hairline bg-surface px-4 py-3">
            <p className="text-tiny font-semibold uppercase tracking-wide text-muted">Where to report</p>
